...
namespace BugSpark
{
    ...
    public class RabinKarpTests
    {
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_1()
        {
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_2()
        {
            List<int> expected_output = new List<int>() {};
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_3()
        {
            List<int> expected_output = new List<int>() {};
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_4()
        {
            List<int> expected_output = new List<int>() {};
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_5()
        {
            List<int> expected_output = new List<int>() {0};
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_6()
        {
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_7()
        {
            List<int> expected_output = new List<int>() {};
            Assert.AreEqual(RabinKarp.FindAllOccurrences("hello", ""), expected_output);
        }
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_8()
        {
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_9()
        {
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_10()
        {
            List<int> expected_output = new List<int>() {};
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_11()
        {
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_12()
        {
            List<int> expected_output = new List<int>() {};
            Assert.AreEqual(RabinKarp.FindAllOccurrences("hello", "how"), expected_output);
        }
        ...
        [Test]
        public void FindAllOccurrences_ISP_Test_13()
        {
            List<int> expected_output = new List<int>() {0};
